...
## [Unreleased]
### Added
- [cpp] add c++ implementation for PrettyFormatter, SummaryFormatter, ProgressFormatter and ProgressBarFormatter ([#126](https://github.com/cucumber/pretty-formatter/pull/126))
...
## [4.0.0] - 2026-06-11
### Changed
- [JavaScript] BREAKING CHANGE: Switch to ESM ([#109](https://github.com/cucumber/pretty-formatter/pull/109))
...
## [3.3.0] - 2026-05-03
### Added
- [JavaScript] Allow suppressing stdout/stderr from progress bar ([#98](https://github.com/cucumber/pretty-formatter/pull/98))

## [3.2.0] - 2026-02-22
### Added
- Show all pertinent steps ([#93](https://github.com/cucumber/pretty-formatter/pull/93))
...
[3.3.0]: https://github.com/cucumber/pretty-formatter/compare/v3.2.0...v3.3.0
[3.2.0]: https://github.com/cucumber/pretty-formatter/compare/v3.1.0...v3.2.0

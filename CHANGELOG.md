...
## [Unreleased]
### Added
- BREAKING CHANGE: Add new JavaScript implementation ([#4](https://github.com/cucumber/pretty-formatter/pull/4))
...
[Unreleased]: https://github.com/cucumber/pretty-formatter/compare/v0.3.0...HEAD
